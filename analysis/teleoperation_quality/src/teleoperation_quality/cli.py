...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--expected-control-hz", type=float, default=30.0)
    parser.add_argument("--expected-physics-hz", type=float, default=120.0)
    parser.add_argument("--expected-render-hz", type=float, default=15.0)
    parser.add_argument("--control-rate-tolerance-fraction", type=float, default=0.02)
    parser.add_argument("--p95-tick-interval-limit-ms", type=float, default=35.0)
    parser.add_argument("--gui-p95-tick-interval-limit-ms", type=float, default=35.0)
