...
H3_MINIMUM_TARGET_FRACTION = 0.05
SEQUENCE_DESCRIPTION_LIMIT_MARGIN_RAD = 0.10

H4_Q20_SEQUENCE_LABELS = Q20_LABELS
H4_SEQUENCE_DEFAULT_DELTA_RAD = 0.12
H4_MAX_DELTA_RAD = 0.15
H4_MINIMUM_TARGET_FRACTION = 0.01
