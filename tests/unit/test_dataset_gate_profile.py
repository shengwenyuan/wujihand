...
def test_gate_profile_freezes_integrity_and_non_blocking_quality_thresholds() -> None:
    ...
    assert profile.profile_id == "mini_dataset_integrity_quality_gate_120_30_v1"
    assert profile.integrity.expected_control_hz == 30.0
    ...
    assert profile.quality.control_hz_lower == (29.75, 29.0, 27.5)
