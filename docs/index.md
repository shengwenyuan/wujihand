...
- [003：双臂双手遥操作质量分析、ROS2 Jazzy 与 Sim→Real 计划](003-teleoperation-quality-analysis-ros2-sim2real-plan.md)
...
- [007：双腕 D405 仿真集成计划](007-isaac-dual-wrist-d405-simulation-plan.md)
- [008：ROS2—Isaac 三目 q54 mini 数据集开发计划](008-ros2-isaac-triview-q54-mini-dataset-development-plan.md)
- [009：脚踏板与自动 reset 多 episode 小计划](009-pedal-auto-reset-multi-episode-mini-feature-plan.md)
...
- [ADR-0011：Mini 数据集因果 artifact 边界](decisions/0011-mini-dataset-causal-artifact-boundary.md)
...
- [2026-07-30 NV-5 ROS 2 Jazzy 离线验证](validation/2026-07-30-nv5-ros2-jazzy-offline.md)
- [2026-07-31 NV-5 ROS 2 Jazzy Workstation2 HIL 验证](validation/2026-07-31-nv5-ros2-jazzy-hil.md)
- [2026-07-31 ROS2 全因果链录制离线验证](validation/2026-07-31-ros2-full-recording-offline.md)
- [2026-08-03 ROS2 全因果录制 Workstation2 无设备验证](validation/2026-08-03-ros2-full-recording-workstation2-device-free.md)
- [2026-08-03 ROS2 banana grasp pilot -02 审计](validation/2026-08-03-ros2-banana-grasp-pilot-02.md)
- [2026-08-03 ROS2 banana grasp pilot -05 有序关闭复验](validation/2026-08-03-ros2-banana-grasp-pilot-05.md)
- [2026-08-03 ROS2 banana grasp pilot -05 质量分析](validation/2026-08-03-ros2-banana-grasp-pilot-05-quality-analysis.md)
- [2026-08-04 NERO + Hand 2 自碰撞资格分析](validation/2026-08-04-nero-hand2-self-collision.md)
- [2026-08-05 ROS2—Isaac 三目 q54 mini 数据集无设备验收](validation/2026-08-05-ros2-isaac-triview-q54-mini-dataset.md)
- [2026-08-06 确定性 ROS2—Isaac—GUI Qualification](validation/2026-08-06-deterministic-ros-isaac-gui-qualification.md)
